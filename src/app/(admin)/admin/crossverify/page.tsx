...
export default async function CrossVerifyPage() {
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">
          All 142 CrossVerify (Digitap) APIs are whitelabeled at <code>/api/v1/{"{slug}"}</code>. Create a client, generate a unique API key + URL, and share it. One key works for all 142 endpoints.
        </p>
      </div>
